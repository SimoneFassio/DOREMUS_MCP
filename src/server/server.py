...
async def associate_to_N_entities(subject: str, obj: str, query_id: str, n: int | None) -> Dict[str, Any]:
    ...
    Args:
        subject: The subject entity for which we want to find a subgraph connected to object
        obj: The object entity to which the subject is connected
    ...
    return associate_to_N_entities_internal(subject, obj, query_id, n)
